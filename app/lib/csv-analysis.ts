// ============================================================
// app/lib/csv-analysis.ts
//
// Shared analysis logic extracted from app/api/analyze-csv/route.ts
// Used by both the submission handler (direct mode) and the QStash worker.
// No Next.js-specific imports in this file.
// ============================================================
...
export const MAX_GROQ_RETRY_WAIT_MS = 30_000 // hard clamp — never sleep more than 30s
...
export function getGroqRateLimitInfo(error: any): { isRateLimit: boolean; retryAfterSeconds: number | null } {
...
export const BANNED_REPLACEMENTS: Array<[RegExp, string]> = [
...
export function applyDeterministicNarrative(report: any, ctx: ReturnType<typeof calculateHealthScore>): void {
...
export function applyOutputGuardrails(report: any): any {
