      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-black rounded-2xl p-6 scroll-fade">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>, title: 'Competitor Sidebar', desc: "Browse any competitor's listing — their top complaints appear in a panel on the right. Their weakness is your next bullet point." },
              { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>, title: 'Review Velocity', desc: 'See when a listing gets a sudden spike in reviews or a rating drop — yours or a competitor\'s — before it affects rankings.' },
              { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>, title: 'SC Health Scanner', desc: 'Every time you open Seller Central, Voxrate reads your account health, stranded inventory, and return rate — and alerts you if something needs action.' },
              { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>, title: 'Instant Review Alerts', desc: 'New 1★ or 2★ review hits your listing — you get an email within hours. Not days. Catch problems while they can still be managed.' },
            ].map(f => (
